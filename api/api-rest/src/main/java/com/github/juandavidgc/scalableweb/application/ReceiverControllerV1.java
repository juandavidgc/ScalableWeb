...
import com.github.juandavidgc.scalableweb.entities.usecases.Receiver;
...
public class ReceiverControllerV1 {
    ...
    public ResponseEntity receiveLeft(@RequestBody @Valid PartRequestMessageV1 partRequest, @PathVariable("ID") String id){
    ...
    public ResponseEntity receiveRight(@RequestBody @Valid PartRequestMessageV1 partRequest, @PathVariable("ID") String id){
